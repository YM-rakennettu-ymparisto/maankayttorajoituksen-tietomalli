...
{% include defintionref_mkr.html id="concept-9" name="maankäyttörajoituksen syntytapa" def="Kaavoitus- ja rakennuslakiin perustuva tapa tai menettely, jonka johdosta maankäyttörajoitus on syntynyt" %}
