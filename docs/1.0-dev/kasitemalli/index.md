...
{% include defintionref_mkr.html id="concept-2" name="maankäyttörajoituksen laji" def="kaavoitus- ja rakennuslain mukaiset maankäyttörajoitukset" note="Maankäyttörajoituksen lajin alakoodit kuvaavat maankäyttöpäätösprosessin ja sen mahdollisen vaiheen ja jossa maankäyttörajoituksesta on päätetty." %}
